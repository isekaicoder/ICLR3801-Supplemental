...
with open('copy.txt', 'w') as f:
    for i in range(num_queries):
        if i % 5 == 0:
            if i == 0:
                lines = ['    <tr>',
                        '        <td><center>Ours (Explicit) ViT32</center></td>',
                        '        <td><center>Ours (Explicit) ViT16</center></td>',
                        '        <td><center>Ours (Explicit) ViT32+ViT14</center></td>',
                        '        <td><center>Ours (Implicit) ViT16</center></td>',
                        '        <td><center>Dream Fields ViT16</center></td>',
                        '    </tr>',
                        '    <tr>',
                        '        <td colspan="5"><center>{}</center></td>'.format(queries[i]),
                        '    </tr>',
                        '    <tr>',
                        '        <td><center><img src="../assets/images/load.jpg" width="224" data-echo="../assets/images/153_gif/ViT32/{}.gif"></center></td>'.format(i),
                        '        <td><center><img src="../assets/images/load.jpg" width="224" data-echo="../assets/images/153_gif/ViT16/{}.gif"></center></td>'.format(i),
                        '        <td><center><img src="../assets/images/load.jpg" width="224" data-echo="../assets/images/153_gif/ViT32_ViT14/{}.gif"></center></td>'.format(i),
                        '        <td><center><img src="../assets/images/load.jpg" width="224" data-echo="../assets/images/153_gif/ViT16_imp/{}.gif"></center></td>'.format(i),
                        '        <td><center><img src="../assets/images/load.jpg" width="224" data-echo="../assets/images/153_gif/ViT16_DF/{}.gif"></center></td>'.format(i),
                        '    </tr>']
            else:
                lines = ['    <tr>',
...
#         '    </tr>',
#         '    <tr>',
#         '        <td><center><img src="/assets/images/153_gif/ViT32/{}.gif" width="224"></center></td>'.format(i),
#         '        <td><center><img src="/assets/images/153_gif/ViT16/{}.gif" width="224"></center></td>'.format(i),
#         '        <td><center><img src="/assets/images/153_gif/ViT32_ViT14/{}.gif" width="224"></center></td>'.format(i),
#         '        <td><center><img src="/assets/images/153_gif/ViT16_imp/{}.gif" width="224"></center></td>'.format(i),
#         '        <td><center><img src="/assets/images/153_gif/ViT16_DF/{}.gif" width="224"></center></td>'.format(i),
#         '    </tr>']
